...
import { signUpUser } from "../../stores/slices/signUpSlice";
...
const SignUp = () => {
  ...
  return (
    <section
      id="register"
      className="flex items-center justify-center mx-auto w-full bg-slate-950 min-h-screen overflow-hidden bg-cover bg-center p-6"
    >
      <div className="bg-white shadow-lg rounded-lg p-8 w-full max-w-lg">
        ...
        <form className="space-y-6" onSubmit={handleSignUp}>
          ...
          <button
            type="submit"
            className="w-full py-3 rounded bg-green-600 text-white font-semibold hover:bg-green-700 transition duration-300"
          >
            สร้างบัญชี
          </button>
